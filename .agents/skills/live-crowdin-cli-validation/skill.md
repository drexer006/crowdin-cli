...
description: >-
  Validates CLI commands against live environments with safe setup and cleanup.
  Use when running `bun run dev ...` or equivalent against real services,
  validating subcommands in parallel, or diagnosing
---
