...
description: >-
  Crowdin CLI 5.0 is a complete rewrite in TypeScript powered by Bun - instant
  startup, no Java required, machine-readable output for scripts and AI agents,
  and more.
tags:
  - release
---
...
![social-card image](<../../../.gitbook/assets/social-card (1).png>)
...
:::tip The TOON version is about **60% smaller** in characters and even cheaper in LLM tokens. :::
...
:::tip Need help or have questions? [Join the discussion](https://github.com/crowdin/crowdin-cli/discussions/1043), [report an issue](https://github.com/crowdin/crowdin-cli/issues), or explore the [documentation](../../../). :::
